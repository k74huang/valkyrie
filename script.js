...
function createImage(count) {
    ...
    image.onclick = function () {
        ...
        imageLarge.src =
            "walls/" +
            this.getAttribute("src").substring(
                7,
                this.getAttribute("src").length
            );
...
function loadImages() {
    ...
    document.getElementById("root").appendChild(rowElem);
    for (i = count - 3; i < count; i++) {
        document.getElementById("row" + row).append('<div class="col-sm>');
        createImage(i);
    }
}
